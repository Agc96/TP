...
int main(int argc, char** argv) {
    ...
    double arrPrecioLibro[MAX_LIBROS],
            arrRecaudadoLibro[MAX_LIBROS]={}, arrRegaliaAutorLibro[MAX_REG_AUTORES], arrRegaliaAutorLibroRecaudado[MAX_REG_AUTORES]={};
...
//    }
    ...
    leerVentas(arrCodLibro, arrPrecioLibro, arrCantidadLibro, arrRecaudadoLibro, cantLibros, fechaIni, fechaFin,arrRegaliaAutorLibroRecaudado, arrRegaliaAutorLibro, arrCodAutor, arrAutorCodLibro, cantRegAutores);
    mostrarReporte(arrCodLibro, arrCodAutor, arrAutorCodLibro, arrCantidadLibro, arrRegaliaAutorLibro, arrRecaudadoLibro, arrPrecioLibro, cantLibros, cantRegAutores, fechaIni, fechaFin, arrRegaliaAutorLibroRecaudado);
